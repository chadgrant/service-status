...
import (
	...
	environmentsvr "github.com/chadgrant/servicestatus/gen/grpc/environment/server"
...
func handleGRPCServer(ctx context.Context, u *url.URL, environmentEndpoints *environment.Endpoints, wg *sync.WaitGroup, errc chan error, logger *log.Logger, debug bool) {
	...
	{
		environmentServer = environmentsvr.New(environmentEndpoints, nil)
	}
	...
	environmentpb.RegisterEnvironmentServer(srv, environmentServer)
